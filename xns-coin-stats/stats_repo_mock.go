...
type StatsRepoMock struct {
	...
	funcCountStats          func() (x1 XnsCoinStats, err error)
	...
	funcInsertStats          func(xcs XnsCoinStats) (err error)
	inspectFuncInsertStats   func(xcs XnsCoinStats)
...
func (mmCountStats *mStatsRepoMockCountStats) Return(x1 XnsCoinStats, err error) *StatsRepoMock {
	if mmCountStats.mock.funcCountStats != nil {
		mmCountStats.mock.t.Fatalf("StatsRepoMock.CountStats mock is already set by Set")
	}
	...
	mmCountStats.defaultExpectation.results = &StatsRepoMockCountStatsResults{x1, err}
	return mmCountStats.mock
}

//Set uses given function f to mock the StatsRepo.CountStats method
func (mmCountStats *mStatsRepoMockCountStats) Set(f func() (x1 XnsCoinStats, err error)) *StatsRepoMock {
	if mmCountStats.defaultExpectation != nil {
...
func (mmCountStats *StatsRepoMock) CountStats() (x1 XnsCoinStats, err error) {
	...
	if mmCountStats.CountStatsMock.defaultExpectation != nil {
		...
		return (*mm_results).x1, (*mm_results).err
	}
...
func (mmInsertStats *mStatsRepoMockInsertStats) Expect(xcs XnsCoinStats) *mStatsRepoMockInsertStats {
	...
	mmInsertStats.defaultExpectation.params = &StatsRepoMockInsertStatsParams{xcs}
...
func (mmInsertStats *mStatsRepoMockInsertStats) Inspect(f func(xcs XnsCoinStats)) *mStatsRepoMockInsertStats {
...
func (mmInsertStats *mStatsRepoMockInsertStats) Set(f func(xcs XnsCoinStats) (err error)) *StatsRepoMock {
	if mmInsertStats.defaultExpectation != nil {
...
// Then helper
func (mmInsertStats *mStatsRepoMockInsertStats) When(xcs XnsCoinStats) *StatsRepoMockInsertStatsExpectation {
	if mmInsertStats.mock.funcInsertStats != nil {
		mmInsertStats.mock.t.Fatalf("StatsRepoMock.InsertStats mock is already set by Set")
	}
	...
	expectation := &StatsRepoMockInsertStatsExpectation{
		...
		params: &StatsRepoMockInsertStatsParams{xcs},
	}
...
func (mmInsertStats *StatsRepoMock) InsertStats(xcs XnsCoinStats) (err error) {
	...
	if mmInsertStats.inspectFuncInsertStats != nil {
		mmInsertStats.inspectFuncInsertStats(xcs)
	}

	mm_params := &StatsRepoMockInsertStatsParams{xcs}
	...
	if mmInsertStats.InsertStatsMock.defaultExpectation != nil {
		...
		mm_got := StatsRepoMockInsertStatsParams{xcs}
	...
	if mmInsertStats.funcInsertStats != nil {
		return mmInsertStats.funcInsertStats(xcs)
	}
	mmInsertStats.t.Fatalf("Unexpected call to StatsRepoMock.InsertStats. %v", xcs)
	return
}
