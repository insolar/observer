...
create type xns_migrations_status as enum('ok', 'ok_error', 'error');
create table if not exists xns_migrations
(
    id bigint generated by default as identity
        constraint xns_migrations_pkey
            primary key,
    daemon_id text not null,
    insolar_ref bytea not null,
    ...
    contract_request_body text not null,
    error text,
)
