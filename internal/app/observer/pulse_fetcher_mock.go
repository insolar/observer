...
func (mmFetch *PulseFetcherMock) Fetch(ctx context.Context, p1 insolar.PulseNumber) (pp1 *Pulse, err error) {
	...
	if mmFetch.FetchMock.defaultExpectation != nil {
		...
		got := PulseFetcherMockFetchParams{ctx, p1}
...
func (mmFetchCurrent *PulseFetcherMock) FetchCurrent(ctx context.Context) (p1 insolar.PulseNumber, err error) {
	...
	mmFetchCurrent.FetchCurrentMock.callArgs = append(mmFetchCurrent.FetchCurrentMock.callArgs, params)
	...
	if mmFetchCurrent.FetchCurrentMock.defaultExpectation != nil {
		...
		want := mmFetchCurrent.FetchCurrentMock.defaultExpectation.params
		got := PulseFetcherMockFetchCurrentParams{ctx}
		if want != nil && !minimock.Equal(*want, got) {
